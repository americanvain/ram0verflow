...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=803"><img src="assets/ledger-light.svg?v=803" width="100%" alt="ROFL ledger, height 803"></picture>

| | |
|---|---|
| **height** | `803` |
| **tip** | `75bfedc15ee2dba2cc0c4a1836487cdca2f96436dbb4f2a529fed3b3530d135c` |
| **difficulty** | `23,722,597,717,411,090,137,088.0`  (bits `0x15032f60`) |
| **chainwork** | `237,666,367,568,487,387,044,297,156,568` expected hashes |
| **supply** | `19462.50000000 ROFL` in `803` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `803` | `75bfedc15ee2dba2cc0c…` | [@uselessfree](https://github.com/uselessfree) | `狗地瓜` | `1` | `6.25000000` | 2026-09-09 11:14 UTC |
| `802` | `ff286a903fad00a89e6a…` | [@uselessfree](https://github.com/uselessfree) | `狗地瓜` | `1` | `6.25000000` | 2026-09-09 11:12 UTC |
| `801` | `50a16b2b582bb647f07e…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `6.25000000` | 2026-09-09 11:09 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `60.7%` |
| [@ram0verflow](https://github.com/ram0verflow) | `62` | `7.7%` |
| [@uselessfree](https://github.com/uselessfree) | `60` | `7.5%` |
| [@eltociear](https://github.com/eltociear) | `49` | `6.1%` |
| [@ywltby](https://github.com/ywltby) | `31` | `3.9%` |
...
| [@uselessfree](https://github.com/uselessfree) | `rofl1qm3zqhkwlh85xsaktutuculxhcqnd8vwnj6rt3z` | `431.25000000 ROFL` |
| _unclaimed_ | `rofl1qyhsqc8t5ldhasar60yfq5u73ga69n94atrg6pt` | `218.75000000 ROFL` |
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `212.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 803. Verify it yourself: <code>python3 verify.py</code></sub>
