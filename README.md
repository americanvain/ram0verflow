...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=115"><img src="assets/ledger-light.svg?v=115" width="100%" alt="ROFL ledger, height 115"></picture>

| | |
|---|---|
| **height** | `115` |
| **tip** | `799490549d735d8b935389077df767800a711ce9fe2b41761fbfae1fdea5f55b` |
| **difficulty** | `876.3`  (bits `0x1d04ac8c`) |
| **chainwork** | `9,026,013,068` expected hashes |
| **supply** | `5800.00000000 ROFL` in `115` unspent outputs |
...
| `107` | `30fc0f433ba864b4e012…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 20:44 UTC |
| `106` | `af0f449e608f8be55c7e…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 20:44 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `77` | `66.4%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `31.9%` |
| [@axewhyzed](https://github.com/axewhyzed) | `1` | `0.9%` |
| [@notram0verflow](https://github.com/notram0verflow) | `1` | `0.9%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `3850.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 115. Verify it yourself: <code>python3 verify.py</code></sub>
