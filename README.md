...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=154"><img src="assets/ledger-light.svg?v=154" width="100%" alt="ROFL ledger, height 154"></picture>

| | |
|---|---|
| **height** | `154` |
| **tip** | `4035428d62ae72761b886ba329d22eff41dd5fc0b4a2b3912e4a4f2564a9b756` |
| **difficulty** | `14,021.4`  (bits `0x1c4ac8c0`) |
| **chainwork** | `240,589,803,811` expected hashes |
| **supply** | `7750.00000000 ROFL` in `154` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `116` | `74.8%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `23.9%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `5800.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 154. Verify it yourself: <code>python3 verify.py</code></sub>
