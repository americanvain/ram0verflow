...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1015"><img src="assets/ledger-light.svg?v=1015" width="100%" alt="ROFL ledger, height 1015"></picture>

| | |
|---|---|
| **height** | `1015` |
| **tip** | `fd3d6051ed7e1b3dd8d5631f8d01a9adf1906489a4a6c473fcb8a16976c334a0` |
| **difficulty** | `144,146,382,902,607,585,683,185,860,608.0`  (bits `0x1208cb50`) |
| **chainwork** | `2,278,467,821,256,684,979,251,485,140,624,146,880` expected hashes |
| **supply** | `20237.50000000 ROFL` in `1015` unspent outputs |
...
| [@bulanzade](https://github.com/bulanzade) | `92` | `9.1%` |
...
| [@sd5884703](https://github.com/sd5884703) | `25` | `2.5%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `78.12500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1015. Verify it yourself: <code>python3 verify.py</code></sub>
