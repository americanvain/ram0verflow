...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=826"><img src="assets/ledger-light.svg?v=826" width="100%" alt="ROFL ledger, height 826"></picture>

| | |
|---|---|
| **height** | `826` |
| **tip** | `15bb7dbb0386fb3fe166012c995d4cb4496734e84f10fa26bc514c40d4811b11` |
| **difficulty** | `78,314,699,855,153,818,763,264.0`  (bits `0x1500f6fd`) |
| **chainwork** | `1,439,473,788,926,567,520,079,050,400,894` expected hashes |
| **supply** | `19606.25000000 ROFL` in `826` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `59.0%` |
...
| [@bulanzade](https://github.com/bulanzade) | `39` | `4.7%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `281.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 826. Verify it yourself: <code>python3 verify.py</code></sub>
