...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=49"><img src="assets/ledger-light.svg?v=49" width="100%" alt="ROFL ledger, height 49"></picture>

| | |
|---|---|
| **height** | `49` |
| **tip** | `528521801a20452e6cb9ff0538e04655511a701a7172500c11b6d39adeb34239` |
| **difficulty** | `3.4`  (bits `0x1e04ac8c`) |
| **chainwork** | `475,899,192` expected hashes |
| **supply** | `2500.00000000 ROFL` in `49` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `74.0%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `11` | `22.0%` |
...
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `550.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 49. Verify it yourself: <code>python3 verify.py</code></sub>
