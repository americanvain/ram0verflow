...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=491"><img src="assets/ledger-light.svg?v=491" width="100%" alt="ROFL ledger, height 491"></picture>

| | |
|---|---|
| **height** | `491` |
| **tip** | `8686d28a70a042a1e9ccdb0a7f113fff0d32e9fb1f1f734e2017e48c19ebad37` |
| **difficulty** | `61,666,598,974,518,408.0`  (bits `0x1712b230`) |
| **chainwork** | `1,120,810,005,229,280,440,082,800` expected hashes |
| **supply** | `16650.00000000 ROFL` in `491` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `453` | `92.1%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `14700.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 491. Verify it yourself: <code>python3 verify.py</code></sub>
