...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1098"><img src="assets/ledger-light.svg?v=1098" width="100%" alt="ROFL ledger, height 1098"></picture>

| | |
|---|---|
| **height** | `1098` |
| **tip** | `efa6b9bc06e9f2e222833d0b8d716d104d23fce81b852e6f41f6b39b0ffb2dc5` |
| **difficulty** | `46,953,529,040,798,350,642,180,505,206,784.0`  (bits `0x1106e957`) |
| **chainwork** | `909,515,650,202,097,024,940,492,296,840,130,502,201` expected hashes |
| **supply** | `20420.31250000 ROFL` in `1098` unspent outputs |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `175.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1098. Verify it yourself: <code>python3 verify.py</code></sub>
