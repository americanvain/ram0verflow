...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=287"><img src="assets/ledger-light.svg?v=287" width="100%" alt="ROFL ledger, height 287"></picture>

| | |
|---|---|
| **height** | `287` |
| **tip** | `46e3416d3f8789ea7d14411105389de2684e5c7c91ef12005ecfd7793ed76355` |
| **difficulty** | `918,903,931.6`  (bits `0x1a4ac8c0`) |
| **chainwork** | `20,555,533,441,082,432` expected hashes |
| **supply** | `12450.00000000 ROFL` in `287` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `249` | `86.5%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `10500.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 287. Verify it yourself: <code>python3 verify.py</code></sub>
