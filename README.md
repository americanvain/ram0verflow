...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1318"><img src="assets/ledger-light.svg?v=1318" width="100%" alt="ROFL ledger, height 1318"></picture>

| | |
|---|---|
| **height** | `1318` |
| **tip** | `8237def7ba67846a9ae120596114d3c002428da55578ef0cd29b143d098a79c4` |
| **difficulty** | `304,713,267,544,757,510,766,286,278,720,648,904,704.0`  (bits `0x0e11de20`) |
| **chainwork** | `4,451,206,705,905,194,282,214,700,581,076,328,990,529,030,217` expected hashes |
| **supply** | `20717.96875000 ROFL` in `1318` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1318. Verify it yourself: <code>python3 verify.py</code></sub>
