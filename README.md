...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1073"><img src="assets/ledger-light.svg?v=1073" width="100%" alt="ROFL ledger, height 1073"></picture>

| | |
|---|---|
| **height** | `1073` |
| **tip** | `39af9bee5a92812468f34b6f6bb37838ea62ca93fe5f07972c05a00af28c8f33` |
| **difficulty** | `15,078,903,884,618,138,773,270,174,892,032.0`  (bits `0x11158578`) |
| **chainwork** | `146,578,595,783,728,239,266,223,602,654,389,061,606` expected hashes |
| **supply** | `20381.25000000 ROFL` in `1073` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1073. Verify it yourself: <code>python3 verify.py</code></sub>
