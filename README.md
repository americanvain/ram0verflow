...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=193"><img src="assets/ledger-light.svg?v=193" width="100%" alt="ROFL ledger, height 193"></picture>

| | |
|---|---|
| **height** | `193` |
| **tip** | `568d107d7e882fc46749b61e09a31233458c804a1aad968cda76a865e71fa8ef` |
| **difficulty** | `897,367.1`  (bits `0x1c012b23`) |
| **chainwork** | `6,900,805,500,002` expected hashes |
| **supply** | `9700.00000000 ROFL` in `193` unspent outputs |
...
| `184` | `8473bf459badecd9ff7b…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 21:29 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `155` | `79.9%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `19.1%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `7750.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 193. Verify it yourself: <code>python3 verify.py</code></sub>
