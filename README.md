...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1034"><img src="assets/ledger-light.svg?v=1034" width="100%" alt="ROFL ledger, height 1034"></picture>

| | |
|---|---|
| **height** | `1034` |
| **tip** | `f2d7e03c4810943ac7e4bb24d4e5175796082812b9803be9fa43ba564501c001` |
| **difficulty** | `457,005,527,059,753,223,622,433,439,744.0`  (bits `0x1202c619`) |
| **chainwork** | `8,758,910,625,008,848,047,518,337,989,162,479,218` expected hashes |
| **supply** | `20296.87500000 ROFL` in `1034` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `32` | `3.1%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `100.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1034. Verify it yourself: <code>python3 verify.py</code></sub>
