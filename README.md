...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1074"><img src="assets/ledger-light.svg?v=1074" width="100%" alt="ROFL ledger, height 1074"></picture>

| | |
|---|---|
| **height** | `1074` |
| **tip** | `78f363fcd3b235ed957565892a83673eed3c49dd1fbca00c2b83e719c606689a` |
| **difficulty** | `15,078,903,884,618,138,773,270,174,892,032.0`  (bits `0x11158578`) |
| **chainwork** | `162,389,972,503,445,588,901,181,401,353,679,744,057` expected hashes |
| **supply** | `20382.81250000 ROFL` in `1074` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `55` | `5.1%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `146.87500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1074. Verify it yourself: <code>python3 verify.py</code></sub>
