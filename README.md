...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=684"><img src="assets/ledger-light.svg?v=684" width="100%" alt="ROFL ledger, height 684"></picture>

| | |
|---|---|
| **height** | `684` |
| **tip** | `a82883b93ebac29dde3ae07bcfac62df230530ec28a877c7fd1bfebd66c78259` |
| **difficulty** | `683,379,584,189,520,384.0`  (bits `0x1701afe5`) |
| **chainwork** | `60,153,302,249,917,296,790,225,521` expected hashes |
| **supply** | `18718.75000000 ROFL` in `684` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `70.7%` |
...
| [@uselessfree](https://github.com/uselessfree) | `22` | `3.2%` |
...
| [@uselessfree](https://github.com/uselessfree) | `rofl1qm3zqhkwlh85xsaktutuculxhcqnd8vwnj6rt3z` | `193.75000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 684. Verify it yourself: <code>python3 verify.py</code></sub>
