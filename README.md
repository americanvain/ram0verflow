...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=48"><img src="assets/ledger-light.svg?v=48" width="100%" alt="ROFL ledger, height 48"></picture>

| | |
|---|---|
| **height** | `48` |
| **tip** | `68752235848c5f1c0e909c61d7b7299ce2926ae88f2c95a877f3bbdef1881866` |
| **difficulty** | `3.4`  (bits `0x1e04ac8c`) |
| **chainwork** | `472,309,724` expected hashes |
| **supply** | `2450.00000000 ROFL` in `48` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `75.5%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `10` | `20.4%` |
...
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `500.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 48. Verify it yourself: <code>python3 verify.py</code></sub>
