...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=149"><img src="assets/ledger-light.svg?v=149" width="100%" alt="ROFL ledger, height 149"></picture>

| | |
|---|---|
| **height** | `149` |
| **tip** | `1a46e2f55167faf948d6610154031ac8592830d712a5fa9c1e75ff25a063bf64` |
| **difficulty** | `14,021.4`  (bits `0x1c4ac8c0`) |
| **chainwork** | `167,077,489,286` expected hashes |
| **supply** | `7500.00000000 ROFL` in `149` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `111` | `74.0%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `24.7%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `5550.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 149. Verify it yourself: <code>python3 verify.py</code></sub>
