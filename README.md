...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1024"><img src="assets/ledger-light.svg?v=1024" width="100%" alt="ROFL ledger, height 1024"></picture>

| | |
|---|---|
| **height** | `1024` |
| **tip** | `063356403882fd90185a8d1d031a8905073fe60f181a0555e325ec9d22f7bac2` |
| **difficulty** | `457,005,527,059,753,223,622,433,439,744.0`  (bits `0x1202c619`) |
| **chainwork** | `3,966,860,349,586,769,952,701,719,483,645,926,038` expected hashes |
| **supply** | `20265.62500000 ROFL` in `1024` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `47.6%` |
| [@ywltby](https://github.com/ywltby) | `121` | `11.8%` |
| [@bulanzade](https://github.com/bulanzade) | `96` | `9.4%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1024. Verify it yourself: <code>python3 verify.py</code></sub>
