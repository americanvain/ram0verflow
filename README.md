...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=482"><img src="assets/ledger-light.svg?v=482" width="100%" alt="ROFL ledger, height 482"></picture>

| | |
|---|---|
| **height** | `482` |
| **tip** | `0848446396bc233451e9960f730927897c65036936928151d68a23960d0e17b7` |
| **difficulty** | `61,666,598,974,518,408.0`  (bits `0x1712b230`) |
| **chainwork** | `538,850,964,052,538,906,550,520` expected hashes |
| **supply** | `16537.50000000 ROFL` in `482` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `444` | `91.9%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `14587.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 482. Verify it yourself: <code>python3 verify.py</code></sub>
