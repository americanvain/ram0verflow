...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=131"><img src="assets/ledger-light.svg?v=131" width="100%" alt="ROFL ledger, height 131"></picture>

| | |
|---|---|
| **height** | `131` |
| **tip** | `e73adf11c4ef1b9a509c94b52c163ba6aa613135c319e087c4196b12efc22a46` |
| **difficulty** | `3,505.3`  (bits `0x1d012b23`) |
| **chainwork** | `34,755,323,144` expected hashes |
| **supply** | `6600.00000000 ROFL` in `131` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `93` | `70.5%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `28.0%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `4650.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 131. Verify it yourself: <code>python3 verify.py</code></sub>
