...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=324"><img src="assets/ledger-light.svg?v=324" width="100%" alt="ROFL ledger, height 324"></picture>

| | |
|---|---|
| **height** | `324` |
| **tip** | `4226c9cbf23cb7be104ec2a41c4b74ac3a71610eb30494e768d5f8b0886c93a5` |
| **difficulty** | `58,809,851,622.1`  (bits `0x1a012b23`) |
| **chainwork** | `637,221,523,186,266,504` expected hashes |
| **supply** | `13375.00000000 ROFL` in `324` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `286` | `88.0%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `11.4%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `11425.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 324. Verify it yourself: <code>python3 verify.py</code></sub>
