...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=667"><img src="assets/ledger-light.svg?v=667" width="100%" alt="ROFL ledger, height 667"></picture>

| | |
|---|---|
| **height** | `667` |
| **tip** | `9309da4b17abbb6659b90fa292f800cdc729543406d3bb7bdaa166232ed39558` |
| **difficulty** | `170,843,737,156,204,160.0`  (bits `0x1706bf97`) |
| **chainwork** | `50,121,251,078,463,643,921,797,064` expected hashes |
| **supply** | `18612.50000000 ROFL` in `667` unspent outputs |
...
| `658` | `392856fca9ea5d23bcec…` | [@ywltby](https://github.com/ywltby) | `gm` | `1` | `6.25000000` | 2026-09-09 04:12 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `72.5%` |
...
| [@ywltby](https://github.com/ywltby) | `22` | `3.3%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `156.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 667. Verify it yourself: <code>python3 verify.py</code></sub>
