...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=889"><img src="assets/ledger-light.svg?v=889" width="100%" alt="ROFL ledger, height 889"></picture>

| | |
|---|---|
| **height** | `889` |
| **tip** | `43f61f26839bfe3f7c34bc7d30a6d76a87f83509c7654a1fa5f2765ddd85d537` |
| **difficulty** | `6,113,755,885,042,390,911,680,512.0`  (bits `0x140329f0`) |
| **chainwork** | `103,662,366,623,643,604,421,692,351,841,324` expected hashes |
| **supply** | `19843.75000000 ROFL` in `889` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `61` | `6.9%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `318.75000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 889. Verify it yourself: <code>python3 verify.py</code></sub>
