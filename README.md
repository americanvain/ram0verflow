...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1082"><img src="assets/ledger-light.svg?v=1082" width="100%" alt="ROFL ledger, height 1082"></picture>

| | |
|---|---|
| **height** | `1082` |
| **tip** | `39da2710cb3deffbdff6e5f1e13ef6594628b96f78ca31dc651842dff38fe74d` |
| **difficulty** | `15,078,903,884,618,138,773,270,174,892,032.0`  (bits `0x11158578`) |
| **chainwork** | `288,880,986,261,184,385,980,843,790,948,005,203,665` expected hashes |
| **supply** | `20395.31250000 ROFL` in `1082` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1082. Verify it yourself: <code>python3 verify.py</code></sub>
