...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=267"><img src="assets/ledger-light.svg?v=267" width="100%" alt="ROFL ledger, height 267"></picture>

| | |
|---|---|
| **height** | `267` |
| **tip** | `95e207e1f3dc3df48fa3345eca398a02c18051cc9b91f80cda04eb0369da4a8c` |
| **difficulty** | `229,725,982.9`  (bits `0x1b012b23`) |
| **chainwork** | `4,175,343,088,475,984` expected hashes |
| **supply** | `11950.00000000 ROFL` in `267` unspent outputs |
...
| `259` | `5bded4629cddc1d65535…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `25.00000000` | 2026-09-06 22:33 UTC |
| `258` | `54e04127d0a88879a1e6…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `25.00000000` | 2026-09-06 22:32 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `229` | `85.4%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `13.8%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `10000.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 267. Verify it yourself: <code>python3 verify.py</code></sub>
