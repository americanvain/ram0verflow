...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=769"><img src="assets/ledger-light.svg?v=769" width="100%" alt="ROFL ledger, height 769"></picture>

| | |
|---|---|
| **height** | `769` |
| **tip** | `b039fc0c6e6b7a6b7ead5c6610c86a8bb58fed955498f0d422ed2d8c8d9b29b4` |
| **difficulty** | `1,673,548,926,011,333,148,672.0`  (bits `0x152d25f6`) |
| **chainwork** | `14,099,346,741,408,269,430,711,003,470` expected hashes |
| **supply** | `19250.00000000 ROFL` in `769` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `63.4%` |
...
| [@MingKeZhiNeng](https://github.com/MingKeZhiNeng) | `12` | `1.6%` |
...
| _unclaimed_ | `rofl1qhspne7a9fdpv9ne4x8jvklcf38mn3askher4xh` | `75.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 769. Verify it yourself: <code>python3 verify.py</code></sub>
