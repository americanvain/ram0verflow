...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=975"><img src="assets/ledger-light.svg?v=975" width="100%" alt="ROFL ledger, height 975"></picture>

| | |
|---|---|
| **height** | `975` |
| **tip** | `cc6542edf70d0952b5f97dbf9efa5119c0e9446daa88b4fcacc42e8e7ff1cba4` |
| **difficulty** | `4,602,904,183,629,444,675,627,122,688.0`  (bits `0x13011367`) |
| **chainwork** | `105,894,413,227,327,349,973,969,579,193,487,856` expected hashes |
| **supply** | `20112.50000000 ROFL` in `975` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `975` | `cc6542edf70d0952b5f9…` | [@bulanzade](https://github.com/bulanzade) | `gm` | `1` | `3.12500000` | 2026-09-09 20:39 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `50.0%` |
| [@ywltby](https://github.com/ywltby) | `119` | `12.2%` |
| [@uselessfree](https://github.com/uselessfree) | `86` | `8.8%` |
| [@bulanzade](https://github.com/bulanzade) | `74` | `7.6%` |
...
| [@sd5884703](https://github.com/sd5884703) | `3` | `0.3%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `400.00000000 ROFL` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `9.37500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 975. Verify it yourself: <code>python3 verify.py</code></sub>
