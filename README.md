...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=105"><img src="assets/ledger-light.svg?v=105" width="100%" alt="ROFL ledger, height 105"></picture>

| | |
|---|---|
| **height** | `105` |
| **tip** | `3dd430aab61e7592d81a06018f713db6d0bea29d0ea65b3afe931ccfd81c5d7f` |
| **difficulty** | `219.1`  (bits `0x1d12b230`) |
| **chainwork** | `3,972,041,452` expected hashes |
| **supply** | `5300.00000000 ROFL` in `105` unspent outputs |
...
| `96` | `d5ec0eaca59b79767ab4…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 20:41 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `67` | `63.2%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `34.9%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `3350.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 105. Verify it yourself: <code>python3 verify.py</code></sub>
