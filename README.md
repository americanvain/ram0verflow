...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=112"><img src="assets/ledger-light.svg?v=112" width="100%" alt="ROFL ledger, height 112"></picture>

| | |
|---|---|
| **height** | `112` |
| **tip** | `ce4df223c8f71a5966e6f1a606aedb7ace05aaf3d6597386e6037d85da035b86` |
| **difficulty** | `876.3`  (bits `0x1d04ac8c`) |
| **chainwork** | `6,269,301,275` expected hashes |
| **supply** | `5650.00000000 ROFL` in `112` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `74` | `65.5%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `32.7%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `3700.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 112. Verify it yourself: <code>python3 verify.py</code></sub>
