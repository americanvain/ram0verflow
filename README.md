...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=176"><img src="assets/ledger-light.svg?v=176" width="100%" alt="ROFL ledger, height 176"></picture>

| | |
|---|---|
| **height** | `176` |
| **tip** | `c4bdeff010b395ddf86861907d3d6e92d60403842fab59fe84c2d4e639cd9ed4` |
| **difficulty** | `224,341.8`  (bits `0x1c04ac8c`) |
| **chainwork** | `1,490,299,150,776` expected hashes |
| **supply** | `8850.00000000 ROFL` in `176` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `138` | `78.0%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `20.9%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `6900.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 176. Verify it yourself: <code>python3 verify.py</code></sub>
