...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1201"><img src="assets/ledger-light.svg?v=1201" width="100%" alt="ROFL ledger, height 1201"></picture>

| | |
|---|---|
| **height** | `1201` |
| **tip** | `548bde3b7c46a0d3e7e9c0957193e029622d46f5c56f3e67471d28fc068a05a8` |
| **difficulty** | `114,703,532,438,693,275,745,159,380,545,306,624.0`  (bits `0x1000b96a`) |
| **chainwork** | `1,165,831,117,210,839,749,868,039,774,816,625,982,898,646` expected hashes |
| **supply** | `20581.25000000 ROFL` in `1201` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1201` | `548bde3b7c46a0d3e7e9…` | [@sd5884703](https://github.com/sd5884703) | `社会实验·连续挖矿` | `1` | `1.56250000` | 2026-09-10 09:40 UTC |
...
| [@sd5884703](https://github.com/sd5884703) | `119` | `9.9%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `246.87500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1201. Verify it yourself: <code>python3 verify.py</code></sub>
