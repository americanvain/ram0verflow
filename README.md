...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1127"><img src="assets/ledger-light.svg?v=1127" width="100%" alt="ROFL ledger, height 1127"></picture>

| | |
|---|---|
| **height** | `1127` |
| **tip** | `c5d61a052ba7b68a0b2dbdfd0c7f34e0051fd5f3707a039824cdd469687308ae` |
| **difficulty** | `498,491,654,147,727,674,996,364,574,457,856.0`  (bits `0x1100a6a8`) |
| **chainwork** | `7,796,668,654,103,551,669,571,725,567,727,238,466,512` expected hashes |
| **supply** | `20465.62500000 ROFL` in `1127` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1127. Verify it yourself: <code>python3 verify.py</code></sub>
