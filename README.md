...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=459"><img src="assets/ledger-light.svg?v=459" width="100%" alt="ROFL ledger, height 459"></picture>

| | |
|---|---|
| **height** | `459` |
| **tip** | `d19c77c189252e1178c71e52e4b24c45e58a2b9734ec9d265af9793f867d1514` |
| **difficulty** | `3,854,162,435,907,400.5`  (bits `0x18012b23`) |
| **chainwork** | `70,050,625,326,830,448,982,852` expected hashes |
| **supply** | `16250.00000000 ROFL` in `459` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `421` | `91.5%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `14300.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 459. Verify it yourself: <code>python3 verify.py</code></sub>
