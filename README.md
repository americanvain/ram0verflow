...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=47"><img src="assets/ledger-light.svg?v=47" width="100%" alt="ROFL ledger, height 47"></picture>

| | |
|---|---|
| **height** | `47` |
| **tip** | `466ed78a258c5a3a02bb73cb7e4a8ab7c28d1c2df047118d5a8a9b1ee168e4f2` |
| **difficulty** | `3.8`  (bits `0x1e043a8b`) |
| **chainwork** | `468,720,256` expected hashes |
| **supply** | `2400.00000000 ROFL` in `47` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `77.1%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `9` | `18.8%` |
| [@axewhyzed](https://github.com/axewhyzed) | `1` | `2.1%` |
| [@notram0verflow](https://github.com/notram0verflow) | `1` | `2.1%` |
...
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `450.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 47. Verify it yourself: <code>python3 verify.py</code></sub>
