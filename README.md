...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=224"><img src="assets/ledger-light.svg?v=224" width="100%" alt="ROFL ledger, height 224"></picture>

| | |
|---|---|
| **height** | `224` |
| **tip** | `f9f8a0f8076651ae4fd489558bfc039b1c3dc7bff9fc657c5397dfb05b1e0f53` |
| **difficulty** | `14,357,873.9`  (bits `0x1b12b230`) |
| **chainwork** | `95,350,822,339,647` expected hashes |
| **supply** | `10875.00000000 ROFL` in `224` unspent outputs |
...
| `215` | `6c790e0ba5e4a1da135c…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `25.00000000` | 2026-09-06 21:53 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `186` | `82.7%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `8925.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 224. Verify it yourself: <code>python3 verify.py</code></sub>
