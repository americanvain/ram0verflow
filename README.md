...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1126"><img src="assets/ledger-light.svg?v=1126" width="100%" alt="ROFL ledger, height 1126"></picture>

| | |
|---|---|
| **height** | `1126` |
| **tip** | `3414c1146cd0f2da9a4264f2fe67d836ffa87c8f764797b598cf592203e80a73` |
| **difficulty** | `498,491,654,147,727,674,996,364,574,457,856.0`  (bits `0x1100a6a8`) |
| **chainwork** | `7,273,962,269,363,943,964,210,397,087,682,039,668,794` expected hashes |
| **supply** | `20464.06250000 ROFL` in `1126` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `81` | `7.2%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `187.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1126. Verify it yourself: <code>python3 verify.py</code></sub>
