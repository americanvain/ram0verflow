...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=872"><img src="assets/ledger-light.svg?v=872" width="100%" alt="ROFL ledger, height 872"></picture>

| | |
|---|---|
| **height** | `872` |
| **tip** | `80a0ad9428b48cbcc0f674c933bc9f015eac105f7486c71298f66a28de94eefe` |
| **difficulty** | `1,693,379,838,721,532,310,323,200.0`  (bits `0x140b6c30`) |
| **chainwork** | `27,125,527,510,130,621,444,903,698,951,474` expected hashes |
| **supply** | `19790.62500000 ROFL` in `872` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `55.9%` |
...
| [@ywltby](https://github.com/ywltby) | `49` | `5.6%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `281.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 872. Verify it yourself: <code>python3 verify.py</code></sub>
