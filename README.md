...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=841"><img src="assets/ledger-light.svg?v=841" width="100%" alt="ROFL ledger, height 841"></picture>

| | |
|---|---|
| **height** | `841` |
| **tip** | `6feac87eba87856e5623b409577404d6e7b48509e01477301830bb2fe9054817` |
| **difficulty** | `130,663,645,067,987,463,962,624.0`  (bits `0x15009409`) |
| **chainwork** | `3,220,175,985,411,256,677,010,756,041,864` expected hashes |
| **supply** | `19693.75000000 ROFL` in `841` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 841. Verify it yourself: <code>python3 verify.py</code></sub>
