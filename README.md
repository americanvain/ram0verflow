...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=383"><img src="assets/ledger-light.svg?v=383" width="100%" alt="ROFL ledger, height 383"></picture>

| | |
|---|---|
| **height** | `383` |
| **tip** | `4070e4dcb2d344178991a0a0f61c60954570416345f7e8d934b8de3965b47a76` |
| **difficulty** | `3,763,830,503,815.8`  (bits `0x1904ac8c`) |
| **chainwork** | `84,195,463,133,658,710,144` expected hashes |
| **supply** | `14850.00000000 ROFL` in `383` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `383` | `4070e4dcb2d344178991…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `25.00000000` | 2026-09-07 01:15 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `345` | `89.8%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `9.6%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `12900.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 383. Verify it yourself: <code>python3 verify.py</code></sub>
