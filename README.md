...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=12"><img src="assets/ledger-light.svg?v=12" width="100%" alt="ROFL ledger, height 12"></picture>

| | |
|---|---|
| **height** | `12` |
| **tip** | `8c9f89d9678b96ff16ff17136e53d3ce74595d7329f02522c22e06bf2a095564` |
| **difficulty** | `16.0`  (bits `0x1e010000`) |
| **chainwork** | `218,103,795` expected hashes |
| **supply** | `650.00000000 ROFL` in `12` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ram0verflow](https://github.com/ram0verflow) | `12` | `92.3%` |
| [@notram0verflow](https://github.com/notram0verflow) | `1` | `7.7%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 12. Verify it yourself: <code>python3 verify.py</code></sub>
