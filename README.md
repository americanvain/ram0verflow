...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=869"><img src="assets/ledger-light.svg?v=869" width="100%" alt="ROFL ledger, height 869"></picture>

| | |
|---|---|
| **height** | `869` |
| **tip** | `4d01927fbd8764eaa74a3c4b6efb4d615333a47fc34482effa8edadba8493e75` |
| **difficulty** | `1,693,379,838,721,532,310,323,200.0`  (bits `0x140b6c30`) |
| **chainwork** | `21,798,615,136,828,812,690,987,785,902,924` expected hashes |
| **supply** | `19781.25000000 ROFL` in `869` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `56.1%` |
...
| [@ywltby](https://github.com/ywltby) | `46` | `5.3%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `271.87500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 869. Verify it yourself: <code>python3 verify.py</code></sub>
