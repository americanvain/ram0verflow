...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1053"><img src="assets/ledger-light.svg?v=1053" width="100%" alt="ROFL ledger, height 1053"></picture>

| | |
|---|---|
| **height** | `1053` |
| **tip** | `69bc6a4ccbb7fdcc2821dcd6cbc24b32a4ab9bdada1a2856a3ad0b8864561ea8` |
| **difficulty** | `1,451,299,717,634,597,185,588,327,088,128.0`  (bits `0x1200df9b`) |
| **chainwork** | `32,460,108,500,777,701,204,123,135,773,888,983,706` expected hashes |
| **supply** | `20350.00000000 ROFL` in `1053` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `42` | `4.0%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `126.56250000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1053. Verify it yourself: <code>python3 verify.py</code></sub>
