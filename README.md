...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=90"><img src="assets/ledger-light.svg?v=90" width="100%" alt="ROFL ledger, height 90"></picture>

| | |
|---|---|
| **height** | `90` |
| **tip** | `d49fed6c598ac4dc8237e685956b9eddf28da07df008813f59e28c811ac3d279` |
| **difficulty** | `54.8`  (bits `0x1d4ac8c0`) |
| **chainwork** | `1,387,624,157` expected hashes |
| **supply** | `4550.00000000 ROFL` in `90` unspent outputs |
...
| `81` | `b8ee03162e7617da5229…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 20:37 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `52` | `57.1%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `40.7%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `2600.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 90. Verify it yourself: <code>python3 verify.py</code></sub>
