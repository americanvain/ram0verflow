...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=396"><img src="assets/ledger-light.svg?v=396" width="100%" alt="ROFL ledger, height 396"></picture>

| | |
|---|---|
| **height** | `396` |
| **tip** | `ee905a606143c8ef8409772d61a52153c3cce4e07aeabdb963e6d42f8241ec97` |
| **difficulty** | `15,055,322,015,263.3`  (bits `0x19012b23`) |
| **chainwork** | `289,421,904,520,855,974,022` expected hashes |
| **supply** | `15175.00000000 ROFL` in `396` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `358` | `90.2%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `13225.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 396. Verify it yourself: <code>python3 verify.py</code></sub>
