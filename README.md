...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1152"><img src="assets/ledger-light.svg?v=1152" width="100%" alt="ROFL ledger, height 1152"></picture>

| | |
|---|---|
| **height** | `1152` |
| **tip** | `c49d04b42433999d3a042d3ce1d350bceba1abfd35f2a7fea1695fa652dc06f0` |
| **difficulty** | `3,865,132,122,365,524,869,624,501,219,885,056.0`  (bits `0x10157e70`) |
| **chainwork** | `37,943,787,771,552,480,370,570,441,255,419,263,134,509` expected hashes |
| **supply** | `20504.68750000 ROFL` in `1152` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `93` | `8.1%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `206.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1152. Verify it yourself: <code>python3 verify.py</code></sub>
