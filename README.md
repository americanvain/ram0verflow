...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1089"><img src="assets/ledger-light.svg?v=1089" width="100%" alt="ROFL ledger, height 1089"></picture>

| | |
|---|---|
| **height** | `1089` |
| **tip** | `d4617bd585812d68476106f6768e694ec6ddb9b88745f5ffc87549f69b2828dc` |
| **difficulty** | `46,953,529,040,798,350,642,180,505,206,784.0`  (bits `0x1106e957`) |
| **chainwork** | `466,406,557,194,739,477,934,698,150,334,580,777,062` expected hashes |
| **supply** | `20406.25000000 ROFL` in `1089` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `67` | `6.1%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1089. Verify it yourself: <code>python3 verify.py</code></sub>
