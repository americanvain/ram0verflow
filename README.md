...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=532"><img src="assets/ledger-light.svg?v=532" width="100%" alt="ROFL ledger, height 532"></picture>

| | |
|---|---|
| **height** | `532` |
| **tip** | `71d6d57b37716eae301165a55f9445dfef77249bc3016421a3c6219b03072879` |
| **difficulty** | `696,931,824,248,621,696.0`  (bits `0x1701a77f`) |
| **chainwork** | `25,725,265,410,308,589,473,447,155` expected hashes |
| **supply** | `17162.50000000 ROFL` in `532` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `90.8%` |
| [@ram0verflow](https://github.com/ram0verflow) | `38` | `7.1%` |
| [@eltociear](https://github.com/eltociear) | `9` | `1.7%` |
...
| _unclaimed_ | `rofl1qdsfz9v9r2hc798k26egt33zxj8ysg4cgwgcw2z` | `112.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 532. Verify it yourself: <code>python3 verify.py</code></sub>
