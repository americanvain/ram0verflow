...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=340"><img src="assets/ledger-light.svg?v=340" width="100%" alt="ROFL ledger, height 340"></picture>

| | |
|---|---|
| **height** | `340` |
| **tip** | `bfbd8f8d623ca0f7c2cc91245680da9f405827ae8305aa572a4745ea96485d71` |
| **difficulty** | `235,239,406,488.5`  (bits `0x194ac8c0`) |
| **chainwork** | `2,548,886,091,396,337,162` expected hashes |
| **supply** | `13775.00000000 ROFL` in `340` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `302` | `88.6%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `11825.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 340. Verify it yourself: <code>python3 verify.py</code></sub>
