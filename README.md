...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=895"><img src="assets/ledger-light.svg?v=895" width="100%" alt="ROFL ledger, height 895"></picture>

| | |
|---|---|
| **height** | `895` |
| **tip** | `6bbe83dec8d9d43428712d8cc3f6495595319c2f58e82c0564a539e1cebc0991` |
| **difficulty** | `6,113,755,885,042,390,911,680,512.0`  (bits `0x140329f0`) |
| **chainwork** | `142,126,792,769,128,861,952,283,265,307,264` expected hashes |
| **supply** | `19862.50000000 ROFL` in `895` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `64` | `7.1%` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 895. Verify it yourself: <code>python3 verify.py</code></sub>
