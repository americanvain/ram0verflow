...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=967"><img src="assets/ledger-light.svg?v=967" width="100%" alt="ROFL ledger, height 967"></picture>

| | |
|---|---|
| **height** | `967` |
| **tip** | `ff600120217541b6d3d84fee12027b4e2c6d17326004f0a8f0a44dd4755f983f` |
| **difficulty** | `4,602,904,183,629,444,675,627,122,688.0`  (bits `0x13011367`) |
| **chainwork** | `67,282,454,369,299,922,662,975,765,320,969,728` expected hashes |
| **supply** | `20087.50000000 ROFL` in `967` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `967` | `ff600120217541b6d3d8…` | [@bulanzade](https://github.com/bulanzade) | `gm` | `1` | `3.12500000` | 2026-09-09 20:14 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `50.4%` |
| [@ywltby](https://github.com/ywltby) | `119` | `12.3%` |
| [@uselessfree](https://github.com/uselessfree) | `86` | `8.9%` |
| [@bulanzade](https://github.com/bulanzade) | `69` | `7.1%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `384.37500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 967. Verify it yourself: <code>python3 verify.py</code></sub>
