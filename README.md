...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=643"><img src="assets/ledger-light.svg?v=643" width="100%" alt="ROFL ledger, height 643"></picture>

| | |
|---|---|
| **height** | `643` |
| **tip** | `2e050cb663c7665db00951d19a9e8943f435ed36ea28021b0d45acfea8842c20` |
| **difficulty** | `42,710,934,289,051,040.0`  (bits `0x171afe5c`) |
| **chainwork** | `47,434,111,440,479,084,815,782,880` expected hashes |
| **supply** | `18462.50000000 ROFL` in `643` unspent outputs |
...
| _unclaimed_ | `rofl1qyhsqc8t5ldhasar60yfq5u73ga69n94atrg6pt` | `156.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 643. Verify it yourself: <code>python3 verify.py</code></sub>
