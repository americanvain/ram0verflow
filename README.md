...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1023"><img src="assets/ledger-light.svg?v=1023" width="100%" alt="ROFL ledger, height 1023"></picture>

| | |
|---|---|
| **height** | `1023` |
| **tip** | `ec9bc00cc5d9b69ab5ff7348febeca706141ff4a4975190ce0661079874e5f6d` |
| **difficulty** | `144,146,382,902,607,585,683,185,860,608.0`  (bits `0x1208cb50`) |
| **chainwork** | `3,487,655,322,044,562,143,220,057,633,094,270,720` expected hashes |
| **supply** | `20262.50000000 ROFL` in `1023` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `1023` | `ec9bc00cc5d9b69ab5ff…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `3.12500000` | 2026-09-09 23:20 UTC |
...
| [@ywltby](https://github.com/ywltby) | `121` | `11.8%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `506.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1023. Verify it yourself: <code>python3 verify.py</code></sub>
