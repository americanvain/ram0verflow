...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=175"><img src="assets/ledger-light.svg?v=175" width="100%" alt="ROFL ledger, height 175"></picture>

| | |
|---|---|
| **height** | `175` |
| **tip** | `707a1f7927b21c333d178e2a0420360adab27263f226168d34e680ce27048200` |
| **difficulty** | `56,085.4`  (bits `0x1c12b230`) |
| **chainwork** | `1,255,059,744,288` expected hashes |
| **supply** | `8800.00000000 ROFL` in `175` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `137` | `77.8%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `21.0%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `6850.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 175. Verify it yourself: <code>python3 verify.py</code></sub>
