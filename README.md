...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=62"><img src="assets/ledger-light.svg?v=62" width="100%" alt="ROFL ledger, height 62"></picture>

| | |
|---|---|
| **height** | `62` |
| **tip** | `84b0382c9ca488b6c2c024a18946e31a78c9cffa1c0341f9e1d7a11989819a5c` |
| **difficulty** | `3.4`  (bits `0x1e04ac8c`) |
| **chainwork** | `522,562,276` expected hashes |
| **supply** | `3150.00000000 ROFL` in `62` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `62` | `84b0382c9ca488b6c2c0…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 20:31 UTC |
| `61` | `dc5b1221522e1f34a156…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 20:30 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `58.7%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `24` | `38.1%` |
...
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `1200.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 62. Verify it yourself: <code>python3 verify.py</code></sub>
