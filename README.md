...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=142"><img src="assets/ledger-light.svg?v=142" width="100%" alt="ROFL ledger, height 142"></picture>

| | |
|---|---|
| **height** | `142` |
| **tip** | `d0fdcc24037cc62ae1e1aba8380443d6b76a948a854530e2e14ce2c6f04c5cdb` |
| **difficulty** | `3,505.3`  (bits `0x1d012b23`) |
| **chainwork** | `75,187,096,130` expected hashes |
| **supply** | `7150.00000000 ROFL` in `142` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `104` | `72.7%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `25.9%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `5200.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 142. Verify it yourself: <code>python3 verify.py</code></sub>
