...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=318"><img src="assets/ledger-light.svg?v=318" width="100%" alt="ROFL ledger, height 318"></picture>

| | |
|---|---|
| **height** | `318` |
| **tip** | `0b2a48d2693da07c00ca1465fe952b3a2aa767658edf4dcfc625270dd1269395` |
| **difficulty** | `14,702,462,905.5`  (bits `0x1a04ac8c`) |
| **chainwork** | `313,471,878,570,044,862` expected hashes |
| **supply** | `13225.00000000 ROFL` in `318` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `280` | `87.8%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `11275.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 318. Verify it yourself: <code>python3 verify.py</code></sub>
