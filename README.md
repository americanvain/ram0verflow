...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1072"><img src="assets/ledger-light.svg?v=1072" width="100%" alt="ROFL ledger, height 1072"></picture>

| | |
|---|---|
| **height** | `1072` |
| **tip** | `7fa19575509e895932ea551e9a5a6ce4630fa06da4900d638d7dbdc4dc376c62` |
| **difficulty** | `15,078,903,884,618,138,773,270,174,892,032.0`  (bits `0x11158578`) |
| **chainwork** | `130,767,219,064,010,889,631,265,803,955,098,379,155` expected hashes |
| **supply** | `20379.68750000 ROFL` in `1072` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `45.5%` |
| [@ywltby](https://github.com/ywltby) | `133` | `12.4%` |
...
| [@sd5884703](https://github.com/sd5884703) | `54` | `5.0%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `537.50000000 ROFL` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `145.31250000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1072. Verify it yourself: <code>python3 verify.py</code></sub>
