...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=203"><img src="assets/ledger-light.svg?v=203" width="100%" alt="ROFL ledger, height 203"></picture>

| | |
|---|---|
| **height** | `203` |
| **tip** | `06de4a152db53744e841f613e9eb0075d2d22a671339b2887945d5544affa583` |
| **difficulty** | `897,367.1`  (bits `0x1c012b23`) |
| **chainwork** | `16,310,381,759,532` expected hashes |
| **supply** | `10200.00000000 ROFL` in `203` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `165` | `80.9%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `18.1%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `8250.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 203. Verify it yourself: <code>python3 verify.py</code></sub>
