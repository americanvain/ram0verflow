...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=937"><img src="assets/ledger-light.svg?v=937" width="100%" alt="ROFL ledger, height 937"></picture>

| | |
|---|---|
| **height** | `937` |
| **tip** | `e434e80ee0281f77d06a899cd8f740ea56ed78835d82be18dac6bfec70fdf61c` |
| **difficulty** | `329,650,888,338,976,240,224,436,224.0`  (bits `0x130f056f`) |
| **chainwork** | `5,384,297,001,662,115,290,178,811,672,187,612` expected hashes |
| **supply** | `19993.75000000 ROFL` in `937` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `937` | `e434e80ee0281f77d06a…` | [@ywltby](https://github.com/ywltby) | `let’s Go~~` | `1` | `3.12500000` | 2026-09-09 18:43 UTC |
| `936` | `bd08b639ce91f55fc1de…` | [@ywltby](https://github.com/ywltby) | `那拿了世界冠军有什么用呢？` | `1` | `3.12500000` | 2026-09-09 18:40 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `52.0%` |
| [@ywltby](https://github.com/ywltby) | `99` | `10.6%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `437.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 937. Verify it yourself: <code>python3 verify.py</code></sub>
