...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=119"><img src="assets/ledger-light.svg?v=119" width="100%" alt="ROFL ledger, height 119"></picture>

| | |
|---|---|
| **height** | `119` |
| **tip** | `8292833f28f777855626da4fbbd3c4a73f009fdc9590cae37a00c88cb73170b5` |
| **difficulty** | `876.3`  (bits `0x1d04ac8c`) |
| **chainwork** | `12,701,628,792` expected hashes |
| **supply** | `6000.00000000 ROFL` in `119` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `81` | `67.5%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `30.8%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `4050.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 119. Verify it yourself: <code>python3 verify.py</code></sub>
