...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=67"><img src="assets/ledger-light.svg?v=67" width="100%" alt="ROFL ledger, height 67"></picture>

| | |
|---|---|
| **height** | `67` |
| **tip** | `c33452dc0380a5261144411def700368ae70fc092d58de8b95d72354a86b2b57` |
| **difficulty** | `13.7`  (bits `0x1e012b23`) |
| **chainwork** | `583,583,236` expected hashes |
| **supply** | `3400.00000000 ROFL` in `67` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `54.4%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `29` | `42.6%` |
...
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `1450.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 67. Verify it yourself: <code>python3 verify.py</code></sub>
