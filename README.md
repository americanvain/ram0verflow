...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=331"><img src="assets/ledger-light.svg?v=331" width="100%" alt="ROFL ledger, height 331"></picture>

| | |
|---|---|
| **height** | `331` |
| **tip** | `4e9d9cfbf549f05dd190154523fab65697ebd150bdeb4373882fb66be5ca99cd` |
| **difficulty** | `58,809,851,622.1`  (bits `0x1a012b23`) |
| **chainwork** | `1,068,887,716,007,895,360` expected hashes |
| **supply** | `13550.00000000 ROFL` in `331` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `293` | `88.3%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `11600.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 331. Verify it yourself: <code>python3 verify.py</code></sub>
