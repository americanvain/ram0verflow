...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=155"><img src="assets/ledger-light.svg?v=155" width="100%" alt="ROFL ledger, height 155"></picture>

| | |
|---|---|
| **height** | `155` |
| **tip** | `5fe95a21c19c44407deaf9f1d720b3edf0297b0ce6f4507d096af3aea5a63f2a` |
| **difficulty** | `14,021.4`  (bits `0x1c4ac8c0`) |
| **chainwork** | `255,292,266,716` expected hashes |
| **supply** | `7800.00000000 ROFL` in `155` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `155` | `5fe95a21c19c44407dea…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 21:09 UTC |
| `154` | `4035428d62ae72761b88…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 21:09 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `117` | `75.0%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `23.7%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `5850.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 155. Verify it yourself: <code>python3 verify.py</code></sub>
