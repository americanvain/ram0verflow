...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=978"><img src="assets/ledger-light.svg?v=978" width="100%" alt="ROFL ledger, height 978"></picture>

| | |
|---|---|
| **height** | `978` |
| **tip** | `f22a86222038ef0b5631a8c81b00e1f6d5bbd712586064c078aed48df88d9729` |
| **difficulty** | `14,748,960,446,377,182,346,115,809,280.0`  (bits `0x1255f2cf`) |
| **chainwork** | `152,290,631,074,388,554,330,137,834,437,109,627` expected hashes |
| **supply** | `20121.87500000 ROFL` in `978` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `49.8%` |
| [@ywltby](https://github.com/ywltby) | `119` | `12.2%` |
| [@uselessfree](https://github.com/uselessfree) | `86` | `8.8%` |
| [@bulanzade](https://github.com/bulanzade) | `76` | `7.8%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `406.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 978. Verify it yourself: <code>python3 verify.py</code></sub>
