...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=940"><img src="assets/ledger-light.svg?v=940" width="100%" alt="ROFL ledger, height 940"></picture>

| | |
|---|---|
| **height** | `940` |
| **tip** | `53d6364c2741e2c04ac767d86663eb68d614158aaa0b92de7e5b1dec0bc6f409` |
| **difficulty** | `329,650,888,338,976,240,224,436,224.0`  (bits `0x130f056f`) |
| **chainwork** | `6,421,289,031,334,906,364,809,866,385,311,542` expected hashes |
| **supply** | `20003.12500000 ROFL` in `940` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `940` | `53d6364c2741e2c04ac7…` | [@ywltby](https://github.com/ywltby) | `天不生我ZmjjKK，瓦圈万古如长夜。` | `1` | `3.12500000` | 2026-09-09 18:52 UTC |
| `939` | `64ebd78ed25f97511c90…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `3.12500000` | 2026-09-09 18:49 UTC |
| `938` | `84aa689065a59d769377…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `3.12500000` | 2026-09-09 18:46 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `51.9%` |
| [@ywltby](https://github.com/ywltby) | `102` | `10.8%` |
| [@uselessfree](https://github.com/uselessfree) | `86` | `9.1%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `446.87500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 940. Verify it yourself: <code>python3 verify.py</code></sub>
