...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=698"><img src="assets/ledger-light.svg?v=698" width="100%" alt="ROFL ledger, height 698"></picture>

| | |
|---|---|
| **height** | `698` |
| **tip** | `bea8df6bbddb965e8a08da44aee38cc66db6127c828857f12ed9a25858217636` |
| **difficulty** | `2,731,242,610,032,180,736.0`  (bits `0x166c1048`) |
| **chainwork** | `93,806,098,504,158,773,514,601,856` expected hashes |
| **supply** | `18806.25000000 ROFL` in `698` unspent outputs |
...
| `689` | `7b420f1961d68d86e86f…` | [@uselessfree](https://github.com/uselessfree) | `gm` | `1` | `6.25000000` | 2026-09-09 05:29 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `486` | `69.5%` |
...
| [@lovivi](https://github.com/lovivi) | `6` | `0.9%` |
...
| _unclaimed_ | `rofl1qgz45v82mfe8ksyyfezss7m2p8udlsdwp0984vv` | `62.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 698. Verify it yourself: <code>python3 verify.py</code></sub>
