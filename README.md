...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=571"><img src="assets/ledger-light.svg?v=571" width="100%" alt="ROFL ledger, height 571"></picture>

| | |
|---|---|
| **height** | `571` |
| **tip** | `88cc87d08de266f9670df5499ada4039da446cd0ebee0cb11b1888673052861b` |
| **difficulty** | `128,191,063,231,935,216.0`  (bits `0x1708fe68`) |
| **chainwork** | `43,979,684,736,566,356,649,899,744` expected hashes |
| **supply** | `17650.00000000 ROFL` in `571` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `84.6%` |
| [@ram0verflow](https://github.com/ram0verflow) | `45` | `7.9%` |
| [@eltociear](https://github.com/eltociear) | `41` | `7.2%` |
...
| [@eltociear](https://github.com/eltociear) | `rofl1qdsfz9v9r2hc798k26egt33zxj8ysg4cgwgcw2z` | `512.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 571. Verify it yourself: <code>python3 verify.py</code></sub>
