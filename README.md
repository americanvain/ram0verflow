...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=814"><img src="assets/ledger-light.svg?v=814" width="100%" alt="ROFL ledger, height 814"></picture>

| | |
|---|---|
| **height** | `814` |
| **tip** | `2366f3f874005cc2355bdca9664f1d1ad6caf5d9894d23b8fa96a55db9441f2a` |
| **difficulty** | `23,722,597,717,411,090,137,088.0`  (bits `0x15032f60`) |
| **chainwork** | `511,290,780,433,939,939,138,020,614,042` expected hashes |
| **supply** | `19531.25000000 ROFL` in `814` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `814` | `2366f3f874005cc2355b…` | [@bulanzade](https://github.com/bulanzade) | `gm` | `1` | `6.25000000` | 2026-09-09 11:55 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `59.9%` |
...
| [@bulanzade](https://github.com/bulanzade) | `27` | `3.3%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `206.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 814. Verify it yourself: <code>python3 verify.py</code></sub>
