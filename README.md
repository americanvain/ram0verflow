...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=483"><img src="assets/ledger-light.svg?v=483" width="100%" alt="ROFL ledger, height 483"></picture>

| | |
|---|---|
| **height** | `483` |
| **tip** | `d0fd2caafa2124e3ae2d4fb474f213926516ba2a5228bac467241946f4240cb5` |
| **difficulty** | `61,666,598,974,518,408.0`  (bits `0x1712b230`) |
| **chainwork** | `603,513,079,738,843,521,387,440` expected hashes |
| **supply** | `16550.00000000 ROFL` in `483` unspent outputs |
...
| `480` | `87b1835451510ee270ec…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `12.50000000` | 2026-09-07 04:14 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `445` | `91.9%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `7.6%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `14600.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 483. Verify it yourself: <code>python3 verify.py</code></sub>
