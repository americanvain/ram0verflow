...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=934"><img src="assets/ledger-light.svg?v=934" width="100%" alt="ROFL ledger, height 934"></picture>

| | |
|---|---|
| **height** | `934` |
| **tip** | `febab6c0c0fc014b47e909ad98159b0f2a60ba3f447eb4d3a7364cad360a5582` |
| **difficulty** | `329,650,888,338,976,240,224,436,224.0`  (bits `0x130f056f`) |
| **chainwork** | `4,347,304,971,989,324,215,547,756,959,063,682` expected hashes |
| **supply** | `19984.37500000 ROFL` in `934` unspent outputs |
...
| [@ywltby](https://github.com/ywltby) | `96` | `10.3%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `428.12500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 934. Verify it yourself: <code>python3 verify.py</code></sub>
