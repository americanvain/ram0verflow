...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=666"><img src="assets/ledger-light.svg?v=666" width="100%" alt="ROFL ledger, height 666"></picture>

| | |
|---|---|
| **height** | `666` |
| **tip** | `4e4ef2428370379217ced013d25e8b33e5eb3d1f6ea0ef367a20960f748b6990` |
| **difficulty** | `170,843,737,156,204,160.0`  (bits `0x1706bf97`) |
| **chainwork** | `49,942,108,435,931,339,981,396,118` expected hashes |
| **supply** | `18606.25000000 ROFL` in `666` unspent outputs |
...
| `657` | `95643f961e232519076e…` | [@ywltby](https://github.com/ywltby) | `gm` | `1` | `6.25000000` | 2026-09-09 04:10 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `72.6%` |
...
| [@uselessfree](https://github.com/uselessfree) | `11` | `1.6%` |
...
| [@uselessfree](https://github.com/uselessfree) | `rofl1qm3zqhkwlh85xsaktutuculxhcqnd8vwnj6rt3z` | `125.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 666. Verify it yourself: <code>python3 verify.py</code></sub>
