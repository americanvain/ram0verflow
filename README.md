...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=486"><img src="assets/ledger-light.svg?v=486" width="100%" alt="ROFL ledger, height 486"></picture>

| | |
|---|---|
| **height** | `486` |
| **tip** | `995df1b68d3a72803c174cf764a156e4eff57477fb7c8d60e6631865b2beb66a` |
| **difficulty** | `61,666,598,974,518,408.0`  (bits `0x1712b230`) |
| **chainwork** | `797,499,426,797,757,365,898,200` expected hashes |
| **supply** | `16587.50000000 ROFL` in `486` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `448` | `92.0%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `14637.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 486. Verify it yourself: <code>python3 verify.py</code></sub>
