...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=139"><img src="assets/ledger-light.svg?v=139" width="100%" alt="ROFL ledger, height 139"></picture>

| | |
|---|---|
| **height** | `139` |
| **tip** | `7a44475d004a5836f363221f85ae9ea25345876c01673d4391672ba6b18e7a4e` |
| **difficulty** | `3,505.3`  (bits `0x1d012b23`) |
| **chainwork** | `64,160,248,952` expected hashes |
| **supply** | `7000.00000000 ROFL` in `139` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `101` | `72.1%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `26.4%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `5050.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 139. Verify it yourself: <code>python3 verify.py</code></sub>
