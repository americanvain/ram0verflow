...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=888"><img src="assets/ledger-light.svg?v=888" width="100%" alt="ROFL ledger, height 888"></picture>

| | |
|---|---|
| **height** | `888` |
| **tip** | `4b0cadaf877bfe6d34a3838c56ec7f69a678a3e753e3c7f21247f7c2c81f4df9` |
| **difficulty** | `6,113,755,885,042,390,911,680,512.0`  (bits `0x140329f0`) |
| **chainwork** | `97,251,628,932,729,394,833,260,532,930,334` expected hashes |
| **supply** | `19840.62500000 ROFL` in `888` unspent outputs |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `315.62500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 888. Verify it yourself: <code>python3 verify.py</code></sub>
