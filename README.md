...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=485"><img src="assets/ledger-light.svg?v=485" width="100%" alt="ROFL ledger, height 485"></picture>

| | |
|---|---|
| **height** | `485` |
| **tip** | `f1ec35c690d77253d3f6831ece56271e8fce9a864727fa378630305d0f060c85` |
| **difficulty** | `61,666,598,974,518,408.0`  (bits `0x1712b230`) |
| **chainwork** | `732,837,311,111,452,751,061,280` expected hashes |
| **supply** | `16575.00000000 ROFL` in `485` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `447` | `92.0%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `14625.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 485. Verify it yourself: <code>python3 verify.py</code></sub>
