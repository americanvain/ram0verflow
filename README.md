...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=428"><img src="assets/ledger-light.svg?v=428" width="100%" alt="ROFL ledger, height 428"></picture>

| | |
|---|---|
| **height** | `428` |
| **tip** | `a8fa2a9e0830322f3b3cd702ed1e4ddf9e18f2bfd2556afd03e65594406a8bca` |
| **difficulty** | `240,885,152,244,212.5`  (bits `0x1812b230`) |
| **chainwork** | `4,630,750,472,326,951,940,834` expected hashes |
| **supply** | `15862.50000000 ROFL` in `428` unspent outputs |
...
| `426` | `e14b5f6df02173a27d0b…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `12.50000000` | 2026-09-07 02:30 UTC |
| `425` | `5af1a4cc0e453ad46b9b…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `12.50000000` | 2026-09-07 02:28 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `390` | `90.9%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `8.6%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `13912.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 428. Verify it yourself: <code>python3 verify.py</code></sub>
