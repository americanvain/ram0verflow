...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=522"><img src="assets/ledger-light.svg?v=522" width="100%" alt="ROFL ledger, height 522"></picture>

| | |
|---|---|
| **height** | `522` |
| **tip** | `538eee9c464c724dc8f52e144e29a7bc19a347c3008d2f4f92df6b3666f7a903` |
| **difficulty** | `986,665,583,592,294,528.0`  (bits `0x17012b23`) |
| **chainwork** | `16,898,366,232,687,606,460,291,280` expected hashes |
| **supply** | `17037.50000000 ROFL` in `522` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `92.5%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `15087.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 522. Verify it yourself: <code>python3 verify.py</code></sub>
