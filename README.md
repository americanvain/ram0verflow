...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1001"><img src="assets/ledger-light.svg?v=1001" width="100%" alt="ROFL ledger, height 1001"></picture>

| | |
|---|---|
| **height** | `1001` |
| **tip** | `5e525ee77a733c711382675cb97e1aefee1494f29e66f2af825fc57bb67034e8` |
| **difficulty** | `42,673,314,336,368,680,331,647,123,456.0`  (bits `0x121db4b8`) |
| **chainwork** | `800,803,040,947,375,049,504,395,507,781,065,888` expected hashes |
| **supply** | `20193.75000000 ROFL` in `1001` unspent outputs |
...
| `992` | `b729ee26aefcc136711f…` | [@bulanzade](https://github.com/bulanzade) | `gm` | `1` | `3.12500000` | 2026-09-09 21:39 UTC |
...
| [@sd5884703](https://github.com/sd5884703) | `17` | `1.7%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `53.12500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1001. Verify it yourself: <code>python3 verify.py</code></sub>
