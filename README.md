...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1306"><img src="assets/ledger-light.svg?v=1306" width="100%" alt="ROFL ledger, height 1306"></picture>

| | |
|---|---|
| **height** | `1306` |
| **tip** | `7f65e8252c2dc3490e937b8f8389c23add7a6eeb96c0334b6428b0d3b9566edc` |
| **difficulty** | `85,351,392,517,528,383,630,677,176,040,602,730,496.0`  (bits `0x0e3fca19`) |
| **chainwork** | `1,767,114,462,499,813,544,668,396,873,481,436,618,552,303,382` expected hashes |
| **supply** | `20708.59375000 ROFL` in `1306` unspent outputs |
...
| [@americanvain](https://github.com/americanvain) | `37` | `2.8%` |
...
| _unclaimed_ | `rofl1qxu56n53xphqyvpxdqgdny8rvg5hvuw5n58s6ke` | `39.84375000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1306. Verify it yourself: <code>python3 verify.py</code></sub>
