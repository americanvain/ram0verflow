...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=619"><img src="assets/ledger-light.svg?v=619" width="100%" alt="ROFL ledger, height 619"></picture>

| | |
|---|---|
| **height** | `619` |
| **tip** | `18ad1ec24b0581d3be121a7a8e498b0eeed6dc6084ddd997a3dfaf2dc6ee26bb` |
| **difficulty** | `9,832,762,024,413,466.0`  (bits `0x177540c9`) |
| **chainwork** | `47,009,355,376,438,991,690,039,380` expected hashes |
| **supply** | `18250.00000000 ROFL` in `619` unspent outputs |
...
| `611` | `e891111b7e7aec583c45…` | [@uselessfree](https://github.com/uselessfree) | `gm` | `1` | `12.50000000` | 2026-09-09 00:57 UTC |
| `610` | `98a685c4bf38665fdc3f…` | [@uselessfree](https://github.com/uselessfree) | `gm` | `1` | `12.50000000` | 2026-09-09 00:46 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `78.1%` |
...
| [@bulanzade](https://github.com/bulanzade) | `3` | `0.5%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `37.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 619. Verify it yourself: <code>python3 verify.py</code></sub>
