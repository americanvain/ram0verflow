...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1167"><img src="assets/ledger-light.svg?v=1167" width="100%" alt="ROFL ledger, height 1167"></picture>

| | |
|---|---|
| **height** | `1167` |
| **tip** | `ece546fa8c0d7846d6fa6432ce2f835c1799818b6efb7bb562994021e9c868fc` |
| **difficulty** | `3,865,132,122,365,524,869,624,501,219,885,056.0`  (bits `0x10157e70`) |
| **chainwork** | `98,737,059,476,675,772,933,736,451,608,053,967,768,224` expected hashes |
| **supply** | `20528.12500000 ROFL` in `1167` unspent outputs |
...
| `1160` | `4a7cfe4f26cb9b83c837…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `1.56250000` | 2026-09-10 07:13 UTC |
| `1159` | `a6b02e6f492fb2e83401…` | [@sd5884703](https://github.com/sd5884703) | `社会实验·连续挖矿` | `1` | `1.56250000` | 2026-09-10 07:10 UTC |
| `1158` | `6a8ad69220619045fcf4…` | [@ethahae](https://github.com/ethahae) | `gm from a C solver` | `1` | `1.56250000` | 2026-09-10 07:04 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `41.8%` |
| [@ywltby](https://github.com/ywltby) | `160` | `13.7%` |
| [@sd5884703](https://github.com/sd5884703) | `99` | `8.5%` |
...
| [@ethahae](https://github.com/ethahae) | `16` | `1.4%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `215.62500000 ROFL` |
...
| _unclaimed_ | `rofl1qnxjnqn35kf6cqutjyfwz4xnldyextf904gxe24` | `25.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1167. Verify it yourself: <code>python3 verify.py</code></sub>
