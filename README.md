...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1134"><img src="assets/ledger-light.svg?v=1134" width="100%" alt="ROFL ledger, height 1134"></picture>

| | |
|---|---|
| **height** | `1134` |
| **tip** | `05700052d7a2cb178bcc3d5d11317f93c70e38762c168a93b0f1e7bc8ab994cd` |
| **difficulty** | `498,491,654,147,727,674,996,364,574,457,856.0`  (bits `0x1100a6a8`) |
| **chainwork** | `11,455,613,347,280,805,607,101,024,928,043,630,050,538` expected hashes |
| **supply** | `20476.56250000 ROFL` in `1134` unspent outputs |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `192.18750000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1134. Verify it yourself: <code>python3 verify.py</code></sub>
