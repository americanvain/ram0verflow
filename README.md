...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1153"><img src="assets/ledger-light.svg?v=1153" width="100%" alt="ROFL ledger, height 1153"></picture>

| | |
|---|---|
| **height** | `1153` |
| **tip** | `f74314e71eede75ef4c7215696cf95e979d02a07c0d8bed27232ac7e15a015c2` |
| **difficulty** | `3,865,132,122,365,524,869,624,501,219,885,056.0`  (bits `0x10157e70`) |
| **chainwork** | `41,996,672,551,894,033,208,114,841,945,594,910,110,090` expected hashes |
| **supply** | `20506.25000000 ROFL` in `1153` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1153. Verify it yourself: <code>python3 verify.py</code></sub>
