...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=484"><img src="assets/ledger-light.svg?v=484" width="100%" alt="ROFL ledger, height 484"></picture>

| | |
|---|---|
| **height** | `484` |
| **tip** | `1eb6846155967aa0e27737b4c34d1d1c20f67f77bcd695f58f5c4939aa14361e` |
| **difficulty** | `61,666,598,974,518,408.0`  (bits `0x1712b230`) |
| **chainwork** | `668,175,195,425,148,136,224,360` expected hashes |
| **supply** | `16562.50000000 ROFL` in `484` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `446` | `92.0%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `14612.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 484. Verify it yourself: <code>python3 verify.py</code></sub>
