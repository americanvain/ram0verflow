...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1054"><img src="assets/ledger-light.svg?v=1054" width="100%" alt="ROFL ledger, height 1054"></picture>

| | |
|---|---|
| **height** | `1054` |
| **tip** | `c6398436b668511db71eab86e26bbe7f94fb430e4b6a9050c8c96c072e50d8e8` |
| **difficulty** | `1,451,299,717,634,597,185,588,327,088,128.0`  (bits `0x1200df9b`) |
| **chainwork** | `33,981,906,553,496,116,497,637,170,669,029,571,413` expected hashes |
| **supply** | `20351.56250000 ROFL` in `1054` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `43` | `4.1%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `128.12500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1054. Verify it yourself: <code>python3 verify.py</code></sub>
