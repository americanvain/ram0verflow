...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=813"><img src="assets/ledger-light.svg?v=813" width="100%" alt="ROFL ledger, height 813"></picture>

| | |
|---|---|
| **height** | `813` |
| **tip** | `3270fa0b781c1c21c2356aa2a50427d42b3987dc6f816fcebc4ddba6f5796f23` |
| **difficulty** | `23,722,597,717,411,090,137,088.0`  (bits `0x15032f60`) |
| **chainwork** | `486,415,833,809,807,888,947,682,117,908` expected hashes |
| **supply** | `19525.00000000 ROFL` in `813` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `813` | `3270fa0b781c1c21c235…` | [@bulanzade](https://github.com/bulanzade) | `gm` | `1` | `6.25000000` | 2026-09-09 11:49 UTC |
...
| [@bulanzade](https://github.com/bulanzade) | `26` | `3.2%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `200.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 813. Verify it yourself: <code>python3 verify.py</code></sub>
