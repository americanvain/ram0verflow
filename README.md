...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=914"><img src="assets/ledger-light.svg?v=914" width="100%" alt="ROFL ledger, height 914"></picture>

| | |
|---|---|
| **height** | `914` |
| **tip** | `f0265b29014dd063e447196bf8d8dbec0ab400ab39a7c49b56bbb825cc523477` |
| **difficulty** | `85,091,074,668,570,659,675,701,248.0`  (bits `0x133a3193`) |
| **chainwork** | `767,738,939,501,086,837,540,356,759,316,022` expected hashes |
| **supply** | `19921.87500000 ROFL` in `914` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `53.3%` |
| [@uselessfree](https://github.com/uselessfree) | `86` | `9.4%` |
| [@ywltby](https://github.com/ywltby) | `79` | `8.6%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `375.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 914. Verify it yourself: <code>python3 verify.py</code></sub>
