...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=518"><img src="assets/ledger-light.svg?v=518" width="100%" alt="ROFL ledger, height 518"></picture>

| | |
|---|---|
| **height** | `518` |
| **tip** | `59caee753c0fa9139590be3a31a2c6cec62005535011ea3279d57f33043b33e4` |
| **difficulty** | `986,665,583,592,294,528.0`  (bits `0x17012b23`) |
| **chainwork** | `12,759,990,828,764,111,110,728,400` expected hashes |
| **supply** | `16987.50000000 ROFL` in `518` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `480` | `92.5%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `15037.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 518. Verify it yourself: <code>python3 verify.py</code></sub>
