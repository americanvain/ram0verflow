...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=268"><img src="assets/ledger-light.svg?v=268" width="100%" alt="ROFL ledger, height 268"></picture>

| | |
|---|---|
| **height** | `268` |
| **tip** | `e0aac0a68b8d07d71a65452fa8b84c4ea313597be6ea5ae64e6810ea30b499fc` |
| **difficulty** | `229,725,982.9`  (bits `0x1b012b23`) |
| **chainwork** | `4,416,228,240,720,196` expected hashes |
| **supply** | `11975.00000000 ROFL` in `268` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `230` | `85.5%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `10025.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 268. Verify it yourself: <code>python3 verify.py</code></sub>
