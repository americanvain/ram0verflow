...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=979"><img src="assets/ledger-light.svg?v=979" width="100%" alt="ROFL ledger, height 979"></picture>

| | |
|---|---|
| **height** | `979` |
| **tip** | `698625740f32a477a6aed46e33da60e8891c570d47dc995c68ec768d56d94a6e` |
| **difficulty** | `14,748,960,446,377,182,346,115,809,280.0`  (bits `0x1255f2cf`) |
| **chainwork** | `167,756,037,023,408,955,782,193,919,518,316,884` expected hashes |
| **supply** | `20125.00000000 ROFL` in `979` unspent outputs |
...
| [@bulanzade](https://github.com/bulanzade) | `77` | `7.9%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `409.37500000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 979. Verify it yourself: <code>python3 verify.py</code></sub>
