...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=354"><img src="assets/ledger-light.svg?v=354" width="100%" alt="ROFL ledger, height 354"></picture>

| | |
|---|---|
| **height** | `354` |
| **tip** | `4130b49863485c76ffcf9ebdff0ba3e45fbed98b0437d9077a06eaecec0bb1b0` |
| **difficulty** | `940,957,625,954.0`  (bits `0x1912b230`) |
| **chainwork** | `8,222,213,197,052,030,747` expected hashes |
| **supply** | `14125.00000000 ROFL` in `354` unspent outputs |
...
| `346` | `af5dfca7f60488f1c1e3…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `25.00000000` | 2026-09-07 00:19 UTC |
| `345` | `6baf32420971d9949819…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `25.00000000` | 2026-09-07 00:18 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `316` | `89.0%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `12175.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 354. Verify it yourself: <code>python3 verify.py</code></sub>
