...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=388"><img src="assets/ledger-light.svg?v=388" width="100%" alt="ROFL ledger, height 388"></picture>

| | |
|---|---|
| **height** | `388` |
| **tip** | `35793d6f07d1566e2b287a8c0221a645f43ea5847b92d663d0ee437c36107641` |
| **difficulty** | `15,055,322,015,263.3`  (bits `0x19012b23`) |
| **chainwork** | `163,128,709,821,042,273,174` expected hashes |
| **supply** | `14975.00000000 ROFL` in `388` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `388` | `35793d6f07d1566e2b28…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `25.00000000` | 2026-09-07 01:24 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `350` | `90.0%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `13025.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 388. Verify it yourself: <code>python3 verify.py</code></sub>
