...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1005"><img src="assets/ledger-light.svg?v=1005" width="100%" alt="ROFL ledger, height 1005"></picture>

| | |
|---|---|
| **height** | `1005` |
| **tip** | `b6b3d71e29b6188e1eae2ee52c5f7baf84d38c69f01e20deb9938467b9e6ae9a` |
| **difficulty** | `42,673,314,336,368,680,331,647,123,456.0`  (bits `0x121db4b8`) |
| **chainwork** | `979,787,893,961,663,560,023,406,934,696,370,656` expected hashes |
| **supply** | `20206.25000000 ROFL` in `1005` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `20` | `2.0%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `62.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1005. Verify it yourself: <code>python3 verify.py</code></sub>
