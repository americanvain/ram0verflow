...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=120"><img src="assets/ledger-light.svg?v=120" width="100%" alt="ROFL ledger, height 120"></picture>

| | |
|---|---|
| **height** | `120` |
| **tip** | `b74d6d5157bd7725aa819c636ebbf2d727c5972900c146d144856555db5db27e` |
| **difficulty** | `876.3`  (bits `0x1d04ac8c`) |
| **chainwork** | `13,620,532,723` expected hashes |
| **supply** | `6050.00000000 ROFL` in `120` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `82` | `67.8%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `30.6%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `4100.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 120. Verify it yourself: <code>python3 verify.py</code></sub>
