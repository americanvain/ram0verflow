...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=962"><img src="assets/ledger-light.svg?v=962" width="100%" alt="ROFL ledger, height 962"></picture>

| | |
|---|---|
| **height** | `962` |
| **tip** | `77bc0497c58c64728e865f3334247a2d00649e7924e3a57a4fc76283f4765c1d` |
| **difficulty** | `4,602,904,183,629,444,675,627,122,688.0`  (bits `0x13011367`) |
| **chainwork** | `43,149,980,083,032,780,593,604,631,650,645,898` expected hashes |
| **supply** | `20071.87500000 ROFL` in `962` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `962` | `77bc0497c58c64728e86…` | [@bulanzade](https://github.com/bulanzade) | `gm` | `1` | `3.12500000` | 2026-09-09 19:57 UTC |
...
| [@bulanzade](https://github.com/bulanzade) | `64` | `6.6%` |
...
| [@bulanzade](https://github.com/bulanzade) | `rofl1qhu2r7ghewxnxgkruvrx94udl3nduj2a5u3w2my` | `368.75000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 962. Verify it yourself: <code>python3 verify.py</code></sub>
