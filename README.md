...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1161"><img src="assets/ledger-light.svg?v=1161" width="100%" alt="ROFL ledger, height 1161"></picture>

| | |
|---|---|
| **height** | `1161` |
| **tip** | `3abcd37870d7911c655d02a3120f5d5a2a67c4e19aedd9544ed623ebf0ef2d8d` |
| **difficulty** | `3,865,132,122,365,524,869,624,501,219,885,056.0`  (bits `0x10157e70`) |
| **chainwork** | `74,419,750,794,626,455,908,470,047,467,000,085,914,738` expected hashes |
| **supply** | `20518.75000000 ROFL` in `1161` unspent outputs |
...
| [@sd5884703](https://github.com/sd5884703) | `97` | `8.3%` |
...
| _unclaimed_ | `rofl1qx5yhylqaa428e8yc3hqseh8z0pe79qe4cpsyxe` | `212.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 1161. Verify it yourself: <code>python3 verify.py</code></sub>
