...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=208"><img src="assets/ledger-light.svg?v=208" width="100%" alt="ROFL ledger, height 208"></picture>

| | |
|---|---|
| **height** | `208` |
| **tip** | `245a7d7983c4f6317f6ffeb13c3b7b54f83de7ac60ebd0cf34448be5cc247e1b` |
| **difficulty** | `3,589,468.5`  (bits `0x1b4ac8c0`) |
| **chainwork** | `23,838,042,767,159` expected hashes |
| **supply** | `10450.00000000 ROFL` in `208` unspent outputs |
...
| `200` | `e2eb66a626848b2ee594…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 21:41 UTC |
| `199` | `dd6c6f6432c87bb8f4ef…` | [@ksanjeev284](https://github.com/ksanjeev284) | `gm` | `1` | `50.00000000` | 2026-09-06 21:41 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `170` | `81.3%` |
| [@ram0verflow](https://github.com/ram0verflow) | `37` | `17.7%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `8500.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 208. Verify it yourself: <code>python3 verify.py</code></sub>
