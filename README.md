...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=906"><img src="assets/ledger-light.svg?v=906" width="100%" alt="ROFL ledger, height 906"></picture>

| | |
|---|---|
| **height** | `906` |
| **tip** | `b9090de9042b48c09c0c2b2ffeb95302c30fa0fc2e310e79f8cbe4a255450ee6` |
| **difficulty** | `21,334,813,272,770,915,134,865,408.0`  (bits `0x1400e819`) |
| **chainwork** | `388,209,697,554,528,235,901,521,322,817,467` expected hashes |
| **supply** | `19896.87500000 ROFL` in `906` unspent outputs |
...
| `897` | `594a6e02226373e81ef0…` | [@ywltby](https://github.com/ywltby) | `let&#x27;s Go~~` | `1` | `3.12500000` | 2026-09-09 16:50 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `53.8%` |
| [@uselessfree](https://github.com/uselessfree) | `86` | `9.5%` |
| [@ywltby](https://github.com/ywltby) | `71` | `7.8%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `350.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 906. Verify it yourself: <code>python3 verify.py</code></sub>
