...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=661"><img src="assets/ledger-light.svg?v=661" width="100%" alt="ROFL ledger, height 661"></picture>

| | |
|---|---|
| **height** | `661` |
| **tip** | `fc8da1e6052ea1227927719bffb1fc3855024a1467bee516e4c771a5e95a026e` |
| **difficulty** | `170,843,737,156,204,160.0`  (bits `0x1706bf97`) |
| **chainwork** | `49,046,395,223,269,820,279,391,388` expected hashes |
| **supply** | `18575.00000000 ROFL` in `661` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `73.1%` |
...
| [@ywltby](https://github.com/ywltby) | `18` | `2.7%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `131.25000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 661. Verify it yourself: <code>python3 verify.py</code></sub>
