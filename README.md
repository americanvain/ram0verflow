...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=372"><img src="assets/ledger-light.svg?v=372" width="100%" alt="ROFL ledger, height 372"></picture>

| | |
|---|---|
| **height** | `372` |
| **tip** | `18152ebd61f0251bdcbc0a02ec408b83c3b284a9785af5ea275112537e62269a` |
| **difficulty** | `3,763,830,503,815.8`  (bits `0x1904ac8c`) |
| **chainwork** | `40,782,177,455,597,750,483` expected hashes |
| **supply** | `14575.00000000 ROFL` in `372` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `334` | `89.5%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `12625.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 372. Verify it yourself: <code>python3 verify.py</code></sub>
