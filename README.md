...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=380"><img src="assets/ledger-light.svg?v=380" width="100%" alt="ROFL ledger, height 380"></picture>

| | |
|---|---|
| **height** | `380` |
| **tip** | `80903c2ca6ba946fc6d282a307312ab360c20b67281720fb4ca4bc02b593f188` |
| **difficulty** | `3,763,830,503,815.8`  (bits `0x1904ac8c`) |
| **chainwork** | `72,355,476,130,551,175,691` expected hashes |
| **supply** | `14775.00000000 ROFL` in `380` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `342` | `89.8%` |
...
|---|---|--:|
| _unclaimed_ | `rofl1qn2wv00sq9a875c7pmqf4hfu2ca2y7fa0le96wk` | `12825.00000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 380. Verify it yourself: <code>python3 verify.py</code></sub>
