...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=662"><img src="assets/ledger-light.svg?v=662" width="100%" alt="ROFL ledger, height 662"></picture>

| | |
|---|---|
| **height** | `662` |
| **tip** | `bc8edf274751b5db8e43ff7f33e51e5c81fb7f81d82aa959ebb41f0e4c5d67a1` |
| **difficulty** | `170,843,737,156,204,160.0`  (bits `0x1706bf97`) |
| **chainwork** | `49,225,537,865,802,124,219,792,334` expected hashes |
| **supply** | `18581.25000000 ROFL` in `662` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `73.0%` |
...
| [@ywltby](https://github.com/ywltby) | `19` | `2.9%` |
...
| _unclaimed_ | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `137.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 662. Verify it yourself: <code>python3 verify.py</code></sub>
