...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=688"><img src="assets/ledger-light.svg?v=688" width="100%" alt="ROFL ledger, height 688"></picture>

| | |
|---|---|
| **height** | `688` |
| **tip** | `a8b66197033811f5bc1a48e158164c30e046afd4cf98d5fc2c96aca9cf171fb0` |
| **difficulty** | `2,731,242,610,032,180,736.0`  (bits `0x166c1048`) |
| **chainwork** | `65,166,943,993,587,732,528,838,336` expected hashes |
| **supply** | `18743.75000000 ROFL` in `688` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ksanjeev284](https://github.com/ksanjeev284) | `484` | `70.2%` |
...
| [@uselessfree](https://github.com/uselessfree) | `25` | `3.6%` |
...
| [@uselessfree](https://github.com/uselessfree) | `rofl1qm3zqhkwlh85xsaktutuculxhcqnd8vwnj6rt3z` | `212.50000000 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 688. Verify it yourself: <code>python3 verify.py</code></sub>
